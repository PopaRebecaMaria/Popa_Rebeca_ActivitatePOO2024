...
public:
	Cofetarie() :adaos(30), anDeschidere(2024) {
		...
		//avand in ved ca nr angajati este 0, salarii e NULL, n are adresa
		this->salarii = NULL;
	}
	...
	*/
	...
	// modificam functia pentru a adauga si salariile noilor angajati in cazul adaugarii unor noi pers
	//il obligam atunci cand adaugam nr angajati sa ne faca si vectorul de salarii
